...
class Anoncreds:
    ...
    async def create_schema(issuer_schema_did: str, schema_name: str, schema_version: str,
                            schema_attributes: Union[list, str]) -> (str, str):
        """"""
        pass
    ...
    async def create_credential_definition(wallet_handle: int, cred_def_did: str, cred_def_schema: Union[dict, str],
                                           ...
                                           cred_def_config: Optional[Union[dict, str]]) -> (str, str):
        """"""
        pass
    ...
    async def create_credential_offer(wallet_handle: int, cred_def_id: str) -> str:
        """"""
        pass
    ...
    async def create_credential(wallet_handle: int, cred_offer: Union[dict, str], cred_request: Union[dict, str],
                                ...
                                tails_reader_handle: Optional[int]) -> (str, Optional[str], Optional[str]):
        """"""
        pass
    ...
    async def merge_revocation_registry_deltas(revoc_reg_delta_1: Union[dict, str],
                                               revoc_reg_delta_2: Union[dict, str]) -> str:
        """"""
        pass
    ...
    async def create_credential_request(wallet_handle: int, cred_req_did: str, cred_offer: Union[dict, str],
                                        cred_def: Union[dict, str], master_secret_id: str) -> (str, str):
        """"""
        pass
    ...
    async def get_credential_by_id(wallet_handle: int, cred_id: str) -> str:
        """"""
        pass

    @staticmethod
    @libindy_command('indy_prover_get_credentials')
    async def get_credentials(wallet_handle: int, credential_filter: Union[dict, str]) -> str:
        """"""
        pass

    @staticmethod
    @libindy_command('indy_prover_get_credentials_for_proof_req')
    async def fetch_credentials_for_proof_request(wallet_handle: int, proof_req: Union[dict, str]) -> str:
        """"""
        pass
    ...
    async def get_credentials_from_search(search_handle: int, cred_count: int) -> str:
        """"""
        pass
    ...
    async def get_credentials_from_proof_request_search(search_handle: int, item_id: str, cred_count: int) -> str:
        """"""
        pass
    ...
    async def create_proof(wallet_handle: int, proof_req: Union[dict, str], proof_creds: Union[dict, str],
                           ...
                           proof_revoc_states: Union[dict, str]) -> str:
        """"""
        pass
    ...
    async def create_revocation_state(tails_reader_handle: int, revoc_reg_defs: Union[dict, str],
                                      revoc_reg_delta: Union[dict, str], timestamp: int, cred_revoc_id: str) -> str:
        """"""
        pass
    ...
    async def update_revocation_state(tails_reader_handle: int, revoc_state: Union[dict, str],
                                      ...
                                      timestamp: int, cred_revoc_id: str) -> str:
        """"""
        pass
