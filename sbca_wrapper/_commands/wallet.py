...
class Wallet:
    ...
    async def delete_wallet(wallet_config: Union[dict, str], wallet_credentials: Union[dict, str]) -> None:
        ...
        :raises InvalidWalletCredentialsError: Raised when trying to delete the
    ...
    async def open_wallet(wallet_config: Union[dict, str], wallet_credentials: Union[dict, str]) -> int:
        ...
        :raises WalletNotFoundError: Raised when no wallet with the given id has
            been found in the specified wallet storage.
        :raises WalletAlreadyOpenError: Raised when the wallet that is to be
            opened is already open.
        :raises InvalidWalletCredentialsError: Raised when trying to open the
            wallet using invalid credentials.
    ...
    async def close_wallet(wallet_handle: int) -> None:
        ...
        :raises InvalidWalletHandleError: Raised when no wallet is open on the
    ...
    async def import_wallet(wallet_config: Union[dict, str], wallet_credentials: Union[dict, str],
        ...
        :raises CommonIOError: Raised when the export file at the specified path
