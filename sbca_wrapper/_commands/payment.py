...
class Payment:
    ...
    async def list_payment_addresses(wallet_handle: int) -> list:
        """"""
        pass
    ...
    async def add_request_fees(wallet_handle: int, sender_did: Optional[str], request: Union[dict, str],
                               inputs: Union[list, str], outputs: Union[list, str],
                               additional_info: Optional[str]) -> (dict, str):
        """"""
        pass

    @staticmethod
    @libindy_command('indy_parse_response_with_fees')
    async def parse_response_with_fees(payment_method: str, response: Union[dict, str]) -> dict:
        """"""
        pass
    ...
    async def build_get_payment_sources_request(wallet_handle: int, sender_did: Optional[str],
                                                payment_address: str) -> (dict, str):
        """"""
        pass

    @staticmethod
    @libindy_command('indy_parse_get_payment_sources_response')
    async def parse_get_payment_sources_response(payment_method: str, response_raw: Union[dict, str]) -> list:
        """"""
        pass

    @staticmethod
    @libindy_command('indy_build_payment_req')
    async def build_payment_request(wallet_handle: int, sender_did: Optional[str], inputs: Union[list, str],
                                    outputs: Union[list, str], additional_info: Optional[str]) -> (dict, str):
        """"""
        pass

    @staticmethod
    @libindy_command('indy_parse_payment_response')
    async def parse_payment_response(payment_method: str, response_raw: Union[dict, str]) -> list:
        """"""
        pass

    @staticmethod
    @libindy_command('indy_build_mint_req')
    async def build_mint_request(wallet_handle: int, sender_did: Optional[str], outputs: Union[list, str],
                                 additional_info: Optional[str]) -> (dict, str):
        """"""
        pass
    ...
    async def build_set_transaction_fees_request(wallet_handle: int, sender_did: Optional[int], payment_method: str,
                                                 transaction_fees: Union[dict, str]) -> dict:
        """"""
        pass
    ...
    async def parse_get_transaction_fees_response(payment_method: str, response_raw: Union[dict, str]) -> dict:
        """"""
        pass

    @staticmethod
    @libindy_command('indy_build_verify_payment_req')
    async def build_verify_payment_request(wallet_handle: int, sender_did: Optional[str], receipt: str) -> (dict, str):
        """"""
        pass

    @staticmethod
    @libindy_command('indy_parse_verify_payment_response')
    async def parse_verify_payment_response(payment_method: str, response_raw: Union[dict, str]) -> dict:
        """"""
        pass
